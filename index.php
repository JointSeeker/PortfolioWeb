...
<head>
    ...
    <meta name="description" content="Webové aplikace, webové stránky, php, html, css">
    <meta name="keywords" content="Portfolio, portfolio, programátor">
    <meta name="author" content="JointSeeker">

    <title>JointSeeker portfolio</title>
...
<header class="navbar">
    <div class="nav">
        <div class="logo"><a href="#"><span>J</span>oint<span>S</span>eeker</a></div>
        <ul class="links">
            <li><a href="#hero">Domu</a></li>
...
<main>
    <section id="hero">
        <h2 class="hero-header">Vítejte</h2>
        <p class="hero-text">
            Dostali jste se až sem na mé stránky! Děkuji.<br>
            Jsem vývojář webových aplikací a moderních webových šablon.
        </p>
    </section>
</main>
<div class="intro">
    <div class="intro-text">
        <h2 class="hide">
            ...
            <span class="text">Budoucnost patří těm,</span>
        </h2>
        <h2 class="hide">
            <span class="text">kdo věří svým krásným snům.</span>
            <span class="text">“</span>
        </h2>
    </div>
</div>
...
<section class="about" >
    ...
    <div class="about-layout" id="about">
        <div class="photo">
            <img src="img/JointSeeker.jpg" alt="Moje foto" width="300">
        </div>
        <div class="about-text">
            <h3><strong>Ludvík Březina</strong></h3>
            <p>Vývojář webových aplikací</p>
            <hr class="breaker">
            <p>Ahoj, zdravím tě, jmenuji se Ludvík Březina. Jsem <strong>vývojář webů a webových aplikací</strong>. Programuji v PHP, ale ovládám také JavaScript, CSS a HTML, Sass. Znám také trochu Python, ale v tom zatím neprogramuji. Učím se taky různé frameworky jako Laravel, Wordpress, Bootstrap,... </p>
        </div>
    </div>
</section>

<section class="services root" >
    <div class="services-header" id="services">
        <h2 class="service-header">Moje služby</h2>
        <p class="service-text">Krátký souhrn služeb, které Vám mohu nabídnout.<br> Hledáte-li moderní webdesign, kompletní realizaci webu nebo máte šablonu stránek a potřebujete ji nakódovat, pak jste našli to správné místo.</p>
    </div>
    <div class="services-layout" id="services-layout">
        <div class="services-item">
            <h3 class="item-header">Webdesing</h3>
            <p class="item-info"><strong>Potřebujete redesign současného webu?</strong>
                Rád Vám pomohu. Na základě vašich požadavků připravím komplexní design.
                Vše ostatní navrhnu dle vašich potřeb.</p>
        </div>
        <div class="services-item" id="web">
            <h3 class="item-header">Kompletní web</h3>
            <p class="item-info">Weby a internet mě baví.
                Webové stránky jsou dnes samostatná kategorie stejně jako webdesign.</p>
        </div>
        <div class="services-item" id="coding">
            <h3 class="item-header">Kódování šablon</h3>
            <p class="item-info">Máte vlastní webdesing a potřebujete ho nakódovat? Nebo potřebujete šablony změnit? Není problém. Pro styly šablon používám Sass, takže se šablony mohou lépe dále rozvíjet či upravovat.
                Dodané šablony jsou v HTML5. V šablonách je použit Bootstrap5.</p>
        </div>
    </div>
</section>
    ...
    <article class="contact-card">
        ...
        <div class="form">
            <form action="#" method="post">
                ...
                <div class="form-input">
                    <label for="email">Pole pro váš email</label>
                    <input type="email" name="email" id="email">
                </div>
                <div class="form-input">
                    <label for="service">Prosím vyberte službu</label>
                    <select name="service" id="service">
                    <option value="">Vyberte ...</option>
                    <option value="1">Webové šablony</option>
                    <option value="2">Kompletní web</option>
                    <option value="3">Redesing webu</option>
                    </select>
                </div>
                <div class="form-input">
                    <label for="message">Zde zadejte vaši zprávu</label>
...
<footer>
    <img src="img/logo.png" alt="Logo Ludvík Březina Vývojář webových aplikací">
    <h5>JointSeeker&copy;</h5>
    <p>Vytvořeno 2023</p>
    <a class="fa-github fa-solid" href="https://www.github.com/JointSeeker"></a>
</footer>
<div id="root"></div>

<script src="js/menu.js"></script>
<script src="js/matrixCanvas.js"></script>
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/gsap/3.11.4/gsap.min.js" integrity="sha512-f8mwTB+Bs8a5c46DEm7HQLcJuHMBaH/UFlcgyetMqqkvTcYg4g5VXsYR71b3qC82lZytjNYvBj2pf0VekA9/FQ=="
